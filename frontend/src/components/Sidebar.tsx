...
export default function Sidebar({ activeTab, setActiveTab, email, appState, onLogout }: SidebarProps) {
  ...
  return (
    <nav className="fixed left-0 top-0 h-full w-64 glass-card border-r border-white/5 flex flex-col p-6 z-50">
